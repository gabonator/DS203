...
public:
	...
	CElfProgram GetProgramBySection( CElfSection& sec );
...
CElf::CElfProgram CElf::GetProgramBySection( CElf::CElfSection& sec )
{
...
void CElf::operator << (CElf::CElfBinary& bin)
{
	m_elfHeader = bin;
...
#define src argv[1] //"C:\\Data\\Devel\\Github\\ds203\\Resources\\SampleAppDyn\\bin\\APP_2.elf"
