...
#if !defined(__DCF77_H__) && defined(ENABLE_MODULE_DCF77)
#define __DCF77_H__
...
public:
	...
	virtual void OnTimer()
	{
		...
		if ( m_bRedraw )
		{
			...
			BIOS::LCD::Printf(20, 240-32-8, RGB565(505050), 0, "BitIndex=%d ", m_nBitIndex );
	...
	void OnWave()
	{
		...
		Sample.nValue = BIOS::ADC::GetAt( 1024 );
		m_nSample = Sample.CH1;
		bool bSignal = ( Sample.CH1 > (int)Settings.Trig.nLevel );
	...
	virtual void OnMessage(CWnd* pSender, ui16 code, ui32 data)
	{
		...
		if (code == ToWord('L', 'E') )
		{
			...
			// 20us -> 120 fps
			// 50us -> 81 fps
			// 100us -> signal was acquired 52 times per second
			// 200us -> 31 fps
			// 500us -> 14 fps
